    ...
    <form id="form1" runat="server">
        <div>
            <table style="font-family: Arial; border: 1px solid black;">
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnGetEmployeeMessageContract" runat="server"
                            Text="Get Employee Message Contract" OnClick="btnGetEmployeeMessageContract_Click" />
                    </td>
                    <td>
                        <asp:Button ID="btnSaveEmployeeContract" runat="server"
                            Text="Save Employee Message Contract" OnClick="btnSaveEmployeeContract_Click" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
